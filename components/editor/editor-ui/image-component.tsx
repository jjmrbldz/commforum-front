              ...
              <RichTextPlugin
                contentEditable={
                  <ContentEditable
                    ...
                    placeholderClassName="ImageNode__placeholder text-sm text-neutral-500 overflow-hidden absolute top-2.5 left-2.5 pointer-events-none text-ellipsis user-select-none whitespace-nowrap inline-block dark:text-neutral-400"
